...
export class DataService {
  ...
  async getCoachesFromSupabase(): Promise<Coach[]> {
    ...
    return (data ?? []).map(c => ({
      ...
      title: c.title,
      bio: c.bio,
      imagePath: this.supabase.getImageUrl(c.image_path),
    }));
  }
  ...
  async getAnnouncementsFromSupabase(): Promise<Announcement[]> {
    ...
    return (data ?? []).map(a => ({
      ...
      imagePath: a.image_path ? this.supabase.getImageUrl(a.image_path) : undefined,
    }));
  }
  ...
  async getSchedulesFromSupabase(): Promise<Schedule[]> {
    ...
    return (data ?? []).map(s => ({
      id: s.id,
      title: s.title,
      imagePath: this.supabase.getImageUrl(s.image_path),
    ...
    return [
      {
        ...
        name: 'Attie Doak',
        title: 'HEAD COACH',
        imagePath: this.supabase.getImageUrl('attie-profile.webp'),
...
I've taught all ages from 18 months to 18 years both girls and boys. I've also done cheer clinics and love working with Cheerleaders to help improve flexibility, stunts and more. I find that teaching little gymnasts self confidence and that hard work, practice and discipline will help them develop the skills necessary for any challenge they face as they become young adults. Watching their confidence, work ethic and skills grow is what makes me love teaching gymnastics more and more everyday. I can't wait to teach and develop your little gymnast at Double Dutch Gymnastics!`
      },
      {
        ...
        imagePath: this.supabase.getImageUrl('gena-profile.webp'),
...
I enjoy the opportunity to teach others gymnastics skills safely while helping them to build their confidence in the sport as I continue to grow in the gymnastics community.`
      },
      {
        ...
        imagePath: this.supabase.getImageUrl('gib-profile.webp'),
        bio: `I started gymnastics at the age of four and continued over the past six years with my love for the sport. I homeschool daily with a focus on learning responsibility, my education, and of course, playing hard.
...
I enjoy the opportunity to teach others gymnastics skills safely while helping them to build their confidence in the sport as I continue to grow in the gymnastics community.`
      },
      {
        ...
        name: 'Ruth',
        title: 'MEET THE TEAM',
        imagePath: this.supabase.getImageUrl('ruth-profile.webp'),
    ...
    return [
      {
        ...
        imagePath: this.supabase.getImageUrl('4I6A3005.webp'),
        duration: '30 minutes',
      ...
      },
      {
        ...
        imagePath: this.supabase.getImageUrl('toddler-bar.webp'),
        duration: '30 minutes',
      ...
      },
      {
        ...
        imagePath: this.supabase.getImageUrl('recreational.webp'),
        duration: '45 minutes',
      ...
      },
      {
        ...
        name: 'Recreational',
        ageRange: 'Ages 6.5+',
        imagePath: this.supabase.getImageUrl('4I6A2769.webp'),
        duration: '60 minutes',
      ...
      },
      {
        ...
        name: 'Pre-Team',
        ageRange: 'Ages 5+',
        imagePath: this.supabase.getImageUrl('kid-handstand.webp'),
        duration: '90 minutes',
    ...
    return [
      {
        ...
        imagePath: this.supabase.getImageUrl('summer-26-schedule.webp'),
